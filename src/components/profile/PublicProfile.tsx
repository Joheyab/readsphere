  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8">
      ...
      <div className="flex items-center gap-5">
        <div className="w-20 h-20 rounded-full overflow-hidden bg-input border border-zinc-700 flex-shrink-0">
          {profile.avatar_url ? (
            <img
            ...
            <div className="w-full h-full flex items-center justify-center text-2xl font-medium text-secondary">
        ...
        <div className="flex-1">
            ...
            <button
              ...
              className={` rounded-xl text-sm font-medium transition cursor-pointer h-8 text-center justify-center items-center w-20  ${
                followData.isFollowing
                  ? "bg-input hover:bg-zinc-700 text-app border border-zinc-700"
                  : "bg-violet-600 hover:bg-violet-500 text-app"
              }`}
            >
              {followLoading
                ? "..."
          ...
          {profile.bio && (
            <p className="text-secondary text-sm mt-1">{profile.bio}</p>
          )}
        ...
        {tabs.map((tab) => (
          <button
            ...
            className={`px-4 py-2.5 text-sm transition ${
              activeTab === tab.key
                ? "text-app border-b-2 border-violet-500 -mb-px"
            ...
            <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-4">
              {library.map((entry) => (
                ...
                >
                  ...
                  <p className="text-app text-xs font-medium line-clamp-2">
                    {entry.books.title}
                  </p>
                </div>
              ))}
          ...
          {reviews.length === 0 ? (
            ...
            reviews.map((review) => (
              <div
                ...
                className="bg-card border border-app rounded-2xl p-5 space-y-3 cursor-pointer hover:border-zinc-700 transition"
              >
                <div className="flex items-center justify-between">
                  {review.books && (
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-12 rounded-lg overflow-hidden bg-input flex-shrink-0">
